  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Thumb
        ...
        className="relative flex-1 rounded-full bg-border/60"
      />
    </ScrollAreaPrimitive.Scrollbar>
  )
}
