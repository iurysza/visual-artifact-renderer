...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-serif text-xl leading-snug font-medium tracking-[-0.015em] group-data-[size=sm]/card:text-base",
        className
      )}
      {...props}
    />
