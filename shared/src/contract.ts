...
export const artifactManifest = {
  ...
  "execution-trace": {
    ...
    description: "Debugger-style execution review with one persistent call stack. Previous/next moves the current frame, updates active-line source context, and shows typed inputs/outputs for that frame. Event code may use content directly or a create-time src path that the CLI safely reads and inlines.",
    props: {
      title: "string?",
      caption: "string?",
