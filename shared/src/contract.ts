...
export const artifactManifest = {
  ...
  "execution-trace": {
    ...
    description: "Boundary-first code execution review. Shows where data/control crosses validation, I/O, process, network, runtime, and registry-adapter boundaries; exposes typed inputs/outputs, transformations, evidence provenance, code references, and call-stack context.",
    props: {
      title: "string?",
      caption: "string?",
      ...
      events: "ExecutionTraceEvent[] (1-100; boundary events require boundary.from/to/kind/outcome; values require typed preview + provenance; callStack carries typed frames)",
